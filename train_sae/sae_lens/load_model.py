...
def load_model(
    ...
    if model_class_name == "AutoModelForCausalLM":
        if "torch_dtype" in model_from_pretrained_kwargs:
            dtype_str = model_from_pretrained_kwargs["torch_dtype"]
            if isinstance(dtype_str, str):
                ...
                model_from_pretrained_kwargs["torch_dtype"] = dtype_map.get(dtype_str, torch.float32)
